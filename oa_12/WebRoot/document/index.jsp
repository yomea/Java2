...
<center>
        ...
        <TBODY>
          ...
          <TR>
            <TD height=14 align=right vAlign=center noWrap>
            	<!-- 在这里插入查询表单 -->
            	【我的公文】 
            	<a href="document.do?method=approvingList">待审公文</a> 
            	<a href="document.do?method=approvedList">已审公文</a>
            </TD>
            ...
            */
            %>
            | <a href="#" onclick="openWin('document.do?method=selectFlow','selectFlow',600,200);">添加公文信息</a>
            </TD>
          </TR>
          <TR>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <td align="center" vAlign="center"><a href="#" onclick="openWin('document.do?method=approvedHistory&id=${document.id}')">查看</a></td>
	          <td align="center" vAlign="center">
	          <c:if test="${document.status eq '新建' }">
	          <a href="#" onclick="openWin('document.do?method=submitInput&id=${document.id}')">提交</a>
	          <a href="#" onclick="del('document.do?method=del&id=${document.id}')">删除</a>
	          </c:if>
	          </td>
        </tr>
        </c:forEach>
