...
<center>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            */
            %>
            <a href="#" onclick="openWin('module.do?method=addInput&parentId=${moduleForm.parentId}','addModule',600,200);">添加模块信息</a>
            <a href="module.do?parentId=0">返回</a>
            </TD>
          </TR>
          <TR>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      ...
		      <td width="8%" height="37" align="center"><b>排序号</b></td>
              <td width="12%" height="37" align="center"><b>操作</b></td>
          </tr>
          <!-- 列表数据栏 -->
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <td align="center" vAlign="center"><a href="module.do?parentId=${module.id }">${module.name }</a></td>
	          ...
	          <a href="#" onclick="openWin('module.do?method=updateInput&id=${module.id}','addorg',600,200)">更新</a>
	          <a href="#" onclick="del('module.do?method=del&id=${module.id}')">删除</a>
	          </td>
        </tr>
        </c:forEach>
		</c:if>
