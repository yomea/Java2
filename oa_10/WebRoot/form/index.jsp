...
<table class="tableEdit" style="width:580px;" cellspacing="0" border="0" cellpadding="0">
	...
	<tr>
		...
		<td>
		<a href="#" onclick="del('flowform.do?method=delField&id=${field.id}')">删除</a>
		<a href="#" onclick="openWin('flowform.do?method=addItemInput&id=${field.id }','additem',700,600)">条目</a>
		</td>
	</tr>
	</c:forEach>
</table>
...
<TABLE>
		<TR align="center">
			...
			<input type="button" class="MyButton"
				value="添加表单域" onclick="openWin('flowform.do?method=formFieldInput&formId=${flowForm.id }','addformfield',600,200)">
			</c:if>
			<input type="button" class="MyButton"
