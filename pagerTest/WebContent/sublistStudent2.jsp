...
<link href="<%=context %>/css/pagination.css" rel="stylesheet" type="text/css">

<script type="text/javascript" src="<%=context %>/js/jquery-1.11.3.js"></script> 
...
$(function(){
	$("#News-Pagination").pagination(${result.totalRows}, {
	...
	<div style="margin-left: 100px; margin-top: 100px;">
		...
		<div>
			<form action="<%=context %>/sublist/SublistServlet" id="stuForm"
				...
				姓名 <input type="text" name="username" id="stu_name"
					style="width: 120px" value="${stuName }"> &nbsp; 性别 <select
					name="gender" id="gender" style="width: 80px">
