...
function showWindow(k, url, mode, cache, menuv) {
	...
	if(k && k !== 'mods' && k !== 'rate' && k.indexOf('miscreport') < 0 && k.indexOf('qclear') < 0) {
...
function simulateSelect(selectId, widthvalue) {
	...
	selectObj.outerHTML += '<div class="element-select-current"><a href="javascript:;" id="' + selectId + '_ctrl" style="width:' + selectwidth + '" tabindex="' + tabindex + '">' + defaultopt + '</a></div>';
